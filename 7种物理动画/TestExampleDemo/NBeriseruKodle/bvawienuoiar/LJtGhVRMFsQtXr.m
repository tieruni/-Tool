...
#import "LJtGhVRMFsQtXr.h"
#import "LJtGhKDIjSghUO.h"
#import "LJtGhXIMaHfNldAlR.h"
#import "LJtGhUZPXBIoFXMjGtygk.h"
#define COUNT 500
@interface LJtGhVRMFsQtXr()<UICollectionViewDelegate,UICollectionViewDataSource>{
    BOOL beganDragging;
}
@property(strong,nonatomic)UICollectionView *myCollectionV;
@property(strong,nonatomic)UICollectionViewFlowLayout *flowL ;
@property(strong,nonatomic)LJtGhXIMaHfNldAlR *bannerControl ;
@property(strong,nonatomic)NSArray *data;
@property(strong,nonatomic)LJtGhMOVUviZaMUrUMlhI *param;
@property(strong,nonatomic)NSTimer *timer;
@property(strong,nonatomic)UIView *line;
@end
@implementation LJtGhVRMFsQtXr
...
- (void)setUp{
    ...
    if (!self.param.wCardOverLap) {
        self.flowL = [[LJtGhKDIjSghUO alloc] initConfigureWithModel:self.param];;
    }else{
        self.param.wRepeat = YES;
        if (self.param.wScaleFactor == 0.5) {
            self.param.wScaleFactor = 0.8f;
        }
        self.flowL = [[LJtGhUZPXBIoFXMjGtygk alloc] initConfigureWithModel:self.param];;
    }
    ...
    self.bannerControl = [[LJtGhXIMaHfNldAlR alloc]initWithFrame:CGRectMake((self.bounds.size.width - 80)/2 , self.bounds.size.height - 30,80, 30) WithModel:self.param];
...
- (LJtGhXIMaHfNldAlR *)bannerControl{
    if (!_bannerControl) {
        _bannerControl = [[LJtGhXIMaHfNldAlR alloc]initWithFrame:CGRectZero WithModel:_param];
    }
...
- (void)setParam:(LJtGhMOVUviZaMUrUMlhI *)param{
    _param = param;
