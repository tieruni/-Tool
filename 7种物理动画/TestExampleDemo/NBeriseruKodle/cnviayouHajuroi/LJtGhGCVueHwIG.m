...
#define People_Name @"xxx"
#define Blessing @"HB"

@interface LJtGhGCVueHwIG ()
{
...
-(instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        [LJtGhGJSZXAep createAnimationLayerWithString:People_Name rect:CGRectMake(Windows_Width / 2 - 150, 250, 300, 150) view:self font:[UIFont systemFontOfSize:40] duretion:5];
        [LJtGhGJSZXAep createAnimationLayerWithString:Blessing rect:CGRectMake(Windows_Width / 2 - 150, Windows_Height - 150, 300, 150) view:self font:[UIFont systemFontOfSize:40] duretion:5];
    }
    return self;
}
...
#pragma mark 画字
-(void)drowTitle{
//    [LJtGhGJSZXAep createAnimationLayerWithString:@"" rect:CGRectMake(Windows_Width / 2 - 150, Windows_Height - 200, 300, 150) view:self font:[UIFont systemFontOfSize:40] duretion:5];
}
