//
//  LJtGhKDTSByPBrIpetSxlSl.m
//  DecodeTest
//
//  Created by Yimmm on 2020/1/2.
//  Copyright © 2020 alpha. All rights reserved.
//

#import "LJtGhKDTSByPBrIpetSxlSl.h"
#import "LJtGhWCURENnDRbJmPeXv.h"
#import "LJtGhFYYqoBqwhb.h"
#import "LJtGhLHWoUrvs.h"
#import "UIView+Extension.h"
#import "LJtGhGCVueHwIG.h"
...
@interface LJtGhKDTSByPBrIpetSxlSl (){
    CABasicAnimation *rotation;
    BOOL first;
}

@property (nonatomic,strong)LJtGhLHWoUrvs * fireView;

@property (nonatomic,strong)LJtGhFYYqoBqwhb * star;

@property (nonatomic,strong)CAEmitterLayer * boomLayer;
@end

@implementation LJtGhKDTSByPBrIpetSxlSl

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor blackColor];
    [self boom];
    _star = [[LJtGhFYYqoBqwhb alloc]initWithFrame:CGRectMake(self.view.bounds.size.width - Star_WidthWithHeight, self.view.bounds.size.height - Star_WidthWithHeight, Star_WidthWithHeight, Star_WidthWithHeight)];
    LJtGhKDTSByPBrIpetSxlSl * weakSelf = self;
    [_star actionFireWithBlock:^{
        LJtGhGCVueHwIG * view = [[LJtGhGCVueHwIG alloc]initWithFrame:weakSelf.view.bounds];
...
- (IBAction)action:(LJtGhWCURENnDRbJmPeXv *)sender {
